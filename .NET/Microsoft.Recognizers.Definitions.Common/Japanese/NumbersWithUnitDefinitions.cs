...
namespace Microsoft.Recognizers.Definitions.Japanese
{
	...
	public static class NumbersWithUnitDefinitions
	{
		...
		public static readonly Dictionary<string, string> CurrencySuffixList = new Dictionary<string, string>
		{
			...
			{ @"Netherlands guilder", @"ユーロ|オランダ・ユーロ" },
			{ @"Surinam florin", @"スリナム・ドル" },
			...
			{ @"Krone", @"クローナ" },
			{ @"Øre", @"オーレ" },
			{ @"West African CFA franc", @"CFAフラン" },
			{ @"Central African CFA franc", @"CFAフラン" },
			...
			{ @"Cook Islands dollar", @"ニュージーランド・ドル|ニュージーランド・ドル" },
			...
			{ @"Kiribati dollar", @"オーストラリア・ドル|オーストラリアドル" },
		...
		public const string CompoundUnitConnectorRegex = @"(?<spacer>と)";
