...
//     - DataFilename: Patterns\French\French-NumbersWithUnit.yaml
//     - Language: French
...
namespace Microsoft.Recognizers.Definitions.French
{
	...
	public static class NumbersWithUnitDefinitions
	{
		...
		{
			{ @"Kilomètre carré", @"km2|km^2|km²|kilomètres carrés|kilomètre carré" },
		...
		{
			{ @"Mètre par seconde", @"m/s|metres/seconde|metres par seconde|metre par seconde|metres par secondes|mètre par seconde|mètres par seconde|mètres par secondes" },
		...
		{
			{ @"Mètre cube", @"m3|m^3|m³|mètre cube|mètres cube|metre cube|metres cube" },
